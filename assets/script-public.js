jQuery(document).ready( function($) {
    ...
    $('.gil_f_save_referer').click( function() {
        ...
        var stringArray = gil_f_referer.name.split(/(\s+)/); // console.log( stringArray[0] +' '+ stringArray[2] );
    ...
    var confirm_that_the_fields_are_cool = function( gil_f_contact_id = '' ) {
        ...
        /*
        Removed because we added 10 friends at once
        var truth = true;
    ...
    var gil_f_save_form_feilds = function(){
        ...
        gil_f_data.forEach( function( field_id , details ){
            ...
            if( $( "#gil_f_fname_"+field_id ).val().length > 0 ){ fields_adds = true ; }
            if( $( "#gil_f_lname_"+field_id ).val().length > 0 ){ fields_adds = true ; }
            if( $( "#gil_f_email_"+field_id).val().length > 0 ){ fields_adds = true ; }
            if( $( "#gil_f_pnumber_"+field_id ).val().length > 0 ){ fields_adds = true ; }
    ...
    $('.gil_f_new_save_contacts').click( function(e){
